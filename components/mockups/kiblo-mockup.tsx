    ...
    <MockupFrame title="Home · bowl" context="onboarding → food → plan → home" status="building" tone={INK}>
      <div className="grid items-center gap-5 sm:grid-cols-[minmax(0,200px)_1fr]">
        ...
        <div className="space-y-3 font-mono text-[10px] uppercase tracking-[0.12em]">
          ...
          <p className="text-[13px] normal-case tracking-normal text-ink">Scan the bag, size the bowl, reorder before it runs out.</p>
          <div className="flex gap-2 pt-1">
            <span className="flex-1 bg-ink py-2 text-center text-[9px] text-bg">Share bowl</span>
            <span className="border border-ink px-3 py-2 text-[9px]">Reorder</span>
            <span className="border border-ink px-3 py-2 text-[9px]">Log</span>
          </div>
        </div>
      </div>
    </MockupFrame>
